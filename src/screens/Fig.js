...
export default class Fig extends React.Component{
    render(){
        return(
          <ImageBackground
                ...
                >
                    ...
                    <View>
                        ...
                        <Chapters
                            ...
                            onPress={()=>this.props.navigation.navigate('Figvid')}
                        />
                         <Chapters
                            num={2}
                            color="#f9e1fc"
                            ...
                            title="Setting up a project in Figma"
                        />
                         <Chapters
                            num={3}
                            color="#e8f1fd"
                        ...
                        />
                         <Chapters
                            ...
                            percent={0}
                            duration="2 hours, 20 minutes"
                            title="Design hacks for fast and beautiful designs"
                        />
                         <Chapters
                            num={5}
                            color="#fbfaf6"
                            ...
                            title="Prototyping, sharing and exporting."
                        />
