...
export default class MERN extends React.Component{
    render(){
        return(
          <ImageBackground
                ...
                >
                    ...
                    <View>
                        ...
                        <Chapters
                            ...
                            onPress={()=>this.props.navigation.navigate('MERNvid')}
                        />
                         <Chapters
                            num={2}
                            color="#f9e1fc"
                        ...
                        />
                         <Chapters
                            ...
                            title="Cross platform Mobile App Development using React Native"
                        />
                         <Chapters
                            num={4}
                            color="#e5ffef"
                            percent={0}
                            duration="4 hours, 20 minutes"
                            title="Server Side Development using NodeJS, Express and MongoDB"
                        />
                    </View>
